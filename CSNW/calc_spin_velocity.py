...
from spin_velocity import calc_velocity_array, get_RAM_dumps, split_velocity_calculation
...
def main():
    ...
    if dumps == 1:
        calc_velocity_array(Nev=Nev, Nk=Nk, save_file=True, k=k)
    else:
        split_velocity_calculation(Nev=Nev, k=k, Nk=Nk)
