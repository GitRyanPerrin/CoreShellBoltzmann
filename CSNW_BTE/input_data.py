...
if shape == "hex" or shape == "sqr":
    ...
    #Nr, Nphi = 10, 100
    Nr, Nphi = 10, 300
if shape == "hex_2D" or shape == "sqr_2D" or shape == "tri_2D":
    Nr, Nphi = 1, 60
# Triangle
if shape == "tri":
...
if material == "InAs":
    ...
    rashba_coeff = 1.171 # eA^2 form, for translating alpha to electric fields, r = alpha/E for InAs
    geff = -14.9
...
if material == "InX":
    ...
    n_3D = 1.15
    rashba_coeff = 3.205
    geff_InX = (geff_InAs + geff_InSb)/2
...
#units_cond = e_SI*tau_e/2/3.14/area
#units_cond = e_SI*1e12
#units_cond = e_SI**2/2/3.14/area*tau_e*1e30
#units_cond = 1.25e-25
#units_cond = e_SI*tau_e/area*1e9/2/pi
#units_cond = e_SI*tau_e/area*1e9/2/pi
#units_cond = e_SI*tau_e*1e-9/2/pi
#units_cond = 2*e_SI*tau_e*1e-6
#units_cond = e_SI*tau_e*1e-6
#units_cond = e_SI*tau_e/area*1e9
#units_cond = e_SI*tau_e/area*1e-10/2/pi
#units_spin = (e_SI*tau_s)**2*hbar_SI/8/3.14/area*1e30
#units_spin = e_SI*tau_s**2*hbar_eV*1e3/8/pi*2*e_SI/hbar_SI/2/pi/area
#units_spin = tau_s**2*hbar_eV*1e-12
#units_seebeck = e_SI*tau_e*1e-9
...
#E = 7*R # Electric Field (meV/R) **radius is not scaled in the Hamiltonian currently
E = 0.0 # Electric Field (meV/R) **radius is not scaled in the Hamiltonian currently
...
#alphaR, betaD = 0.0, betaD_InAs_German
